...
\begin{df}[Basic properties of order for natural numbers]{Proposition 2.2.12}
    ...
    \begin{enumerate}[topsep=0mm,parsep=0mm,label=(\alph*)]
        ...
        \item \textit{$a < b$ if and only if $\succr{a} \le b$.}
...
\begin{df}[Intersection]{Unlabeled Definition}
...
\begin{df}[Laws of algebra for integers]{Proposition 4.1.6}
    ...
    \textit{Remark. } The above set of nine identities asserts that the integers form a \emph{commutative ring}.
    If one deleted the identity $xy = yx$, then they would only assert that the integers form a \emph{ring}.
\end{df}

\begin{df}[Subtraction]{Unlabeled Definition}
    Define the operation of \emph{subtraction} $x - y$ of two integers by the formula
    {\setlength{\belowdisplayskip}{-10pt} \setlength{\belowdisplayshortskip}{-10pt}
    \[
        x - y \coloneqq x + (-y).
    \]
...
\begin{df}[Reciprocal]{Unlabeled Definition}
    If $x = a//b$ is a non-zero rational (so that $a, b \ne 0$) then we define the \emph{reciprocal} $x^{-1}$ of $x$ to be the rational number $x^{-1} \coloneqq b // a$.
    We leave the reciprocal of $0$ undefined.
\end{df}


\begin{df}[Laws of algebra for rationals]{Proposition 4.2.4}
    ...
    \[
        xx^{-1} = x^{-1}x = 1.
    \]
    \textit{Remark. } The above set of ten identities asserts that the rationals form a \emph{field}.
\end{df}


\begin{df}[Quotient]{Unlabeled Definition}
    The \emph{quotient} $x/y$ of two ratonal numbers $x$ and $y$, provided that $y$ is non-zero, is defined by the formula
    {\setlength{\belowdisplayskip}{-10pt} \setlength{\belowdisplayshortskip}{-10pt}
    \[
        x/y = x \times y^{-1}.
    \]
...
\begin{df}[Trichotomy of rationals]{Lemma 4.2.7}
...
\begin{df}[Ordering of the rationals]{Definition 4.2.8}
...
\begin{df}[Basic properties of order on the rationals]{Proposition 4.2.9}
    \begin{enumerate}[topsep=0mm,label=(\alph*)]
...
\begin{df}[Absolute value]{Definition 4.3.1}
...
\begin{df}[Distance]{Definition 4.3.2}
    Let $x$ and $y$ be rational numbers.
...
\begin{df}[Basic properties of absolute value and distance]{Proposition 4.3.3}
    ...
    \begin{enumerate}[topsep=0mm,label=(\alph*)]
        ...
        \item We have the inequalities $-y \le x \le y$ if and only if $y \ge \abs{x}$.
...
\begin{df}[$\varepsilon$-closeness]{Definition 4.3.4}
    Let $\varepsilon > 0$ be a rational number, and let $x, y$ be rational numbers.
    We say that $y$ is \emph{$\varepsilon$-close} to $x$ iff we have $d(y, x) \le \varepsilon$.    
\end{df}


\begin{df}{Proposition 4.3.7}
...
\begin{df}[Exponentiation to a natural number]{Definition 4.3.9}
     Let $x$ be a rational number.
     To raise $x$ to the power $0$, we define $x^0 \coloneqq 1$; in particular we define $0^0 \coloneqq 1$.
     Now suppose inductively that $x^n$ has been defined for some natural number $n$, then we define $x^{n+1} \coloneqq x^n \times x$.
\end{df}


\begin{df}[Properties of exponentiation, I]{Proposition 4.3.10}
    ...
    \begin{enumerate}[topsep=0mm,label=(\alph*)]
        ...
        \item If $x \ge y \ge 0$, then $x^n \ge y^n \ge 0$. If $x > y \ge 0$ and $n > 0$, then $x^n > y^n \ge 0$.
...
\begin{df}[Exponentiation to a negative number]{Definition 4.3.11}
    Let $x$ be a non-zero rational number.
    Then for any negative integer $-n$, we define $x^{-n} \coloneqq 1/x^n$.
\end{df}


\begin{df}[Properties of exponentiation, II]{Proposition 4.3.12}
...
\begin{df}[Interspersing of integers by rationals]{Proposition 4.4.1}
    Let $x$ be a rational number.
...
\begin{df}[Interspersing of rationals by rationals]{Proposition 4.4.3}
...
\begin{df}[Sequences]{Definition 5.1.1}
    Let $m$ be an integer.
    A \emph{sequence $(a_n)^\infty_{n=m}$ of rational numbers} is any function from the set $\{ n \in \mathbb{Z} : n \ge m \}$ to $\mathbb{Q}$,
    i.e., a mapping which assigns to each integer $n$ greater or equal to $m$, a rational number $a_n$.
    More informally, a sequence $(a_n)^\infty_{n=m}$ of rational numbers is a collection of rationals $a_m, a_{m+1}, a_{m+2}, \ldots$.
\end{df}


\begin{df}[$\varepsilon$-steadiness]{Definition 5.1.3}
    Let $\varepsilon > 0$. A sequence $(a_n)^\infty_{n=0}$ is said to be \emph{$\varepsilon$-steady} iff each pair $a_j, a_k$ of sequence elements is $\varepsilon$-close for every natural number $j, k$.
    In other words, the sequence $a_0, a_1, a_2, \ldots$ is $\varepsilon$-steady iff $d(a_j, a_k) \le \varepsilon$ for all $j, k$.
\end{df}


\begin{df}[Eventual $\varepsilon$-steadiness]{Definition 5.1.6}
    Let $\varepsilon > 0$.
    A sequence $(a_n)^\infty_{n=0}$ is said to be \emph{eventually $\varepsilon$-steady} iff the sequence $a_N, a_{N+1}, a_{N+2}, \ldots$ is $\varepsilon$-steady for some natural number $N \ge 0$.
    In other words, the sequence $a_0, a_1, a_2, \ldots$ is eventually $\varepsilon$-steady iff there exists an $N \ge 0$ such that $d(a_j, a_k) \le \varepsilon$ for all $j, k \ge N$.
\end{df}


\begin{df}[Cauchy sequences]{Definition 5.1.8}
    A sequence $(a_n)^\infty_{n=0}$ of rational numbers is said to be a \emph{Cauchy sequence}
    iff for every rational number $\varepsilon > 0$,
    the sequence $(a_n)^\infty_{n=0}$ is eventually $\varepsilon$-steady.
    In other words, the sequence $a_0, a_1, a_2, \ldots$ is a Cauchy sequence iff for every $\varepsilon > 0$, there exists an $N \ge 0$ such that $d(a_j, a_k) \le \varepsilon$ for all $j, k \ge N$.
\end{df}


\begin{df}[Bounded sequences]{Definition 5.1.12}
    Let $M \ge 0$ be rational.
    A finite sequence $a_1, a_2, \ldots, a_n$ is \emph{bounded by $M$} iff $\abs{a_i} \le M$ for all $1 \le i \le n$.
    An infinite sequence $(a_n)^\infty_{n=1}$ is \emph{bounded by $M$} iff $\abs{a_i} \le M$ for all $i \ge 1$.
    A sequence is said to be \emph{bounded} iff it is bounded by $M$ for some rational $M \ge 0$.
\end{df}


\begin{df}[Finite sequences are bounded]{Lemma 5.1.14}
    Every finite sequence $a_1, a_2, \ldots, a_n$ is bounded.
\end{df}


\begin{df}[Cauchy sequences are bounded]{Lemma 5.1.15}
...
\begin{df}[$\varepsilon$-close sequences]{Definition 5.2.1}
    Let $(a_n)^\infty_{n=0}$ and $(b_n)^\infty_{n=0}$ be two sequences, and let $\varepsilon > 0$.
    We say that the sequence $(a_n)^\infty_{n=0}$ is \emph{$\varepsilon$-close} to $(b_n)^\infty_{n=0}$ if $a_n$ is $\varepsilon$-close to $b_n$ for each $n \in \mathbb{N}$.
    In other words, the sequence $a_0, a_1, a_2, \ldots$ is $\varepsilon$-close to the sequence $b_0, b_1, b_2, \ldots$ iff $\abs{a_n - b_n} \le \varepsilon$ for all $n = 0, 1, 2, \ldots$.
\end{df}


\begin{df}[Eventually $\varepsilon$-close sequences]{Definition 5.2.3}
    Let $(a_n)^\infty_{n=0}$ and $(b_n)^\infty_{n=0}$ be two sequences, and let $\varepsilon > 0$.
    We say that the sequence $(a_n)^\infty_{n=0}$ is \emph{eventually $\varepsilon$-close} to $(b_n)^\infty_{n=0}$ iff there exists an $N \ge 0$ such that the sequences $(a_n)^\infty_{n=N}$ and $(b_n)^\infty_{n=N}$ are $\varepsilon$-close.
    In other words, $a_0, a_1, a_2, \ldots$ is eventually $\varepsilon$-close to $b_0, b_1, b_2, \ldots$ iff there exists an $N \ge 0$ such that $\abs{a_n - b_n} \le \varepsilon$ for all $n \ge N$.
\end{df}


\begin{df}[Equivalent sequences]{Definition 5.2.6}
    Two sequences $(a_n)^\infty_{n=0}$ and $(b_n)^\infty_{n=0}$ are \emph{equivalent} iff for each rational $\varepsilon > 0$, the sequences $(a_n)^\infty_{n=0}$ and $(b_n)^\infty_{n=0}$ are eventually $\varepsilon$-close.
    In other words, $a_0, a_1, a_2, \ldots$ and $b_0, b_1, b_2, \ldots$ are equivalent iff for every rational $\varepsilon > 0$, there exists an $N \ge 0$ such that $\abs{a_n - b_n} \le \varepsilon$  for all $n \ge N$.
\end{df}
